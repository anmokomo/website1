...
export async function getCategories(): Promise<Array<Category>> {
    return new Promise<Array<Category>>((res, rej) => {
        setTimeout(() => {
            const categories = [];
...
export async function getThreadsByCategory(
    ...
    return new Promise<Array<Thread>>((res, rej) => {
        setTimeout(() => {
...
export async function getTopCategories(): Promise<Array<CategoryThread>> {
    return new Promise<Array<CategoryThread>>((res, rej) => {
        setTimeout(() => {
            const topCategories = [];
...
export async function getThreadById(Id: string): Promise<Thread> {
    return new Promise<Thread>((res, rej) => {
        setTimeout(() => {
            const thread = {
                id: "1",
                views: 22,
...
export async function getUserThreads(id: string): Promise<Array<Thread>> {
    return new Promise<Array<Thread>>((res) => {
        setTimeout(() => {
            const threads: Array<Thread> = [];
            threads.push({
                id: "1",
